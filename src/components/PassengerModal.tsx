        ...
        <div className='fixed inset-0 border-3 overflow-y-auto'>
          <div className='flex min-h-full items-center justify-center  text-center'>
            <Transition.Child
              ...
              <Dialog.Panel className='w-full  h-max overflow-scroll md:overflow-hidden mt-auto md:m-auto md:relative  sm:max-w-[500px]   rounded-t-[50px] md:rounded-2xl bg-white   shadow-xl '>
                <Dialog.Title
                  as='h3'
                ...
                <div className='flex flex-col mx-4 p-4   text-[#042F40] rounded-xl text-right'>
                  <div>
                    <TextInput
                      ...
                      setValue={(value:string) => updatePassengerData('name', value)}
                      title='الاسم'
                  ...
                  <div className='flex mt-4 justify-start gap-4 items-center '>
                    <div className='w-1/4'>
                      <TextInput
                         ...
                         setValue={(value:number) => updatePassengerData('age', Number(value))}
                        title='العمر'
                        placeholder=''
                        type='number'
                      />
                    ...
                    <div className='w-1/2 mx-auto mt-auto '>
                      <SwitchSlide
                        ...
                        setInitial={(value:number) => updatePassengerData('gender', value)}
                      />
                    </div>
                  </div>
                  <div className='flex mt-4'>
                    ...
                    value={passengerData?.phone} 
                      setValue={(value:string) => updatePassengerData('phone', value)}
                      title=' رقم الجوال'
                      placeholder=''
                      type='number'
                    />
                  ...
                  <div className='flex mt-4'>
                    ...
                    value={passengerData?.email} 
                      setValue={(value:string) => updatePassengerData('email', value)}
                      title='  الايميل'
                      placeholder=''
                      type='text'
                    />
