import { CreditCardIcon, UsersIcon,CalendarDaysIcon } from '@heroicons/react/24/solid';
...
const MiniTicketSkeleton:React.FC =() => {
    ...
    return (
        <div className='bg-inherit relative flex items-center justify-center  '>
         ...
         <div className={` upper-part2  rounded-lg  shadow-lg  py-2 px-4 w-full mx-2 ${false? 'bg-rose-100':'bg-gray-200'} `}>
