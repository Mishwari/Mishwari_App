  ...
  return (
    <>
      <Transition
        ...
        <Dialog
          as='div'
          className='fixed inset-0 z-10 overflow-y-auto opacity-100'
          ...
          <Transition.Child
            ...
            <div className='bg-slate-100 w-64 h-full absolute right-0 top-0 '>
              <div className='bg-[#005687] p-4 relative'>
                <div
                  className='absolute right-0 mr-2 h-6 w-6 bg-white hover:bg-gray-200 active:bg-gray-400 cursor-pointer overflow-hidden rounded-full rotate-180'
              ...
              <div className='p-4 text-white '>
                ...
                <h2
                  ...
                  className='text-lg font-semibold border rounded-md p-2 bg-[#005687] cursor-poi'>
                  تسجيل الخروج
                </h2>
              </div>
            </div>
