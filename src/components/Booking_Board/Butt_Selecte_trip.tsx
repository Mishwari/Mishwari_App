...
function Butt_Selecte_trip() {
  ...
  return (
    <div className='py-6 px-2  '>
      <div className='flex justify-between items-center bg-slate-100 rounded-3xl md:flex md:justify-center md:gap-96 md:items-center '>
        <button onClick={() => Togglebtn(1)} className={`text-[#005687] rounded-l-3xl h-12 w-28 md:flex-1 md:w-full ${togglebtn === 1 ? `bg-[#005687] text-white` : ``} `}>Within City</button>
