          ...
          <div className='fixed inset-y-0 right-0  max-w-full flex'>
            <Transition.Child
              ...
              <div className='w-screen max-w-md'>
                <div className='md:hidden md:relative  h-full divide-y divide-gray-200 flex flex-col bg-white shadow-xl'>
                  {/* our filters */}
                  ...
                  <FilterGroup filteredTrips={filteredTrips} filterBuses={localFilters} setFilterBuses={setLocalFilters}/>
