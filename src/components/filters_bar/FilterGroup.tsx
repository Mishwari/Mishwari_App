...
// }
  ...
  function areAllArraysEmpty(obj: any) {
      return Object.entries(obj).filter(([key]) => key !== 'Min' && key !== 'Max')
      .every(([_, arr]) => Array.isArray(arr) && arr.length === 0);;
      console.log('our array',filterBuses)
    }
  ...
  return (
    <div className=' flex flex-col py-3  overflow-y-scroll md:overflow-auto'>
